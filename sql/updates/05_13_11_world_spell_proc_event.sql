...
(85113, 0, 5, NULL, 8388608, NULL, 87376, 0, 0, 0, 0),
(85114, 0, 5, NULL, 8388608, NULL, 87376, 0, 0, 0, 0);

-- Improved Soul Fire fix

DELETE FROM `spell_proc_event` where entry IN ( 18120, 18119 );
INSERT INTO `spell_proc_event` (`entry`, `SchoolMask`, `SpellFamilyName`, `SpellFamilyMask0`, `SpellFamilyMask1`, `SpellFamilyMask2`, `procFlags`, `procEx`, `ppmRate`, `CustomChance`, `Cooldown`) VALUES
 ('18120', '0', '5', NULL, '128', NULL, '0', '0', '0', '100', '0'),
 ('18119', '0', '5', NULL, '128', NULL, '0', '0', '0', '100', '0');

-- Exploit Weakness fix

DELETE FROM `spell_proc_event` where entry IN (51632, 91023); 
INSERT INTO `spell_proc_event` (`entry`, `SchoolMask`, `SpellFamilyName`, `SpellFamilyMask0`, `SpellFamilyMask1`, `SpellFamilyMask2`, `procFlags`, `procEx`, `ppmRate`, `CustomChance`, `Cooldown`) VALUES
(51632, 0, 8, 8390400, 0, NULL, 4112, 0, 0, 0, 0),
(91023, 0, 8, 8390400, 0, NULL, 4112, 0, 0, 0, 0);
...
INSERT INTO `spell_proc_event` (`entry`, `SchoolMask`, `SpellFamilyName`, `SpellFamilyMask0`, `SpellFamilyMask1`, `SpellFamilyMask2`, `procFlags`, `procEx`, `ppmRate`, `CustomChance`, `Cooldown`) VALUES 
('85510', '0', '0', '2097152', NULL, NULL, '81920', '0', '0', '50', '0'),
('31825', '0', '0', '2097152', NULL, NULL, '81920', '0', '0', '50', '0');
...
INSERT INTO `spell_proc_event` (`entry`, `SchoolMask`, `SpellFamilyName`, `SpellFamilyMask0`, `SpellFamilyMask1`, `SpellFamilyMask2`, `procFlags`, `procEx`, `ppmRate`, `CustomChance`, `Cooldown`) VALUES
('87192', '0', '0', '8192', NULL, NULL, '65536', '2', '', '0', '0'),
('87195', '0', '0', '8192', NULL, NULL, '65536', '2', '0', '0', '0');
