...
SpellFamilyMask0=536870912 WHERE entry IN (20503, 20502);
...
UPDATE spell_proc_event SET 
SpellFamilyMask0=8, procFlags=4112, procEx=3 WHERE entry IN (61216, 61221);
...
UPDATE spell_proc_event SET 
SpellFamilyMask1='17179869184' WHERE entry IN (12329, 12950);

-- Bloodsurge proc fix
UPDATE spell_proc_event SET 
SpellFamilyMask0='4398046511104', SpellFamilyMask1='0' WHERE entry IN (46913, 46914, 46915);
