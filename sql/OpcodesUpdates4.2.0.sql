...
UPDATE emuopcodes SET number = 45795 WHERE name = "SMSG_CHAR_CREATE" and version = @ver;
...
UPDATE emuopcodes SET number = 16122 WHERE name = "SMSG_CHARACTER_LOGIN_FAILED" and version = @ver;