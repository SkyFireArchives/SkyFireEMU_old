...
--
-- Poèítaè: localhost
-- Vygenerováno: Úterý 24. kvìtna 2011, 10:17
-- Verze MySQL: 5.1.54
...
--
-- Struktura tabulky `account_data`
--
...
--
-- Struktura tabulky `account_instance_times`
--
...
--
-- Struktura tabulky `account_tutorial`
--
...
--
-- Struktura tabulky `arena_team_member`
--
...
--
-- Struktura tabulky `auctionhouse`
--
...
--
-- Struktura tabulky `character_account_data`
--
...
--
-- Struktura tabulky `character_achievement`
--
...
--
-- Struktura tabulky `character_achievement_progress`
--
...
--
-- Struktura tabulky `character_action`
--
...
--
-- Struktura tabulky `character_arena_stats`
--
...
--
-- Struktura tabulky `character_aura`
--
...
--
-- Struktura tabulky `character_banned`
--
...
--
-- Struktura tabulky `character_battleground_data`
--
...
--
-- Struktura tabulky `character_battleground_random`
--
...
--
-- Struktura tabulky `character_declinedname`
--
...
--
-- Struktura tabulky `character_equipmentsets`
--
...
--
-- Struktura tabulky `character_gifts`
--
...
--
-- Struktura tabulky `character_glyphs`
--
...
--
-- Struktura tabulky `character_homebind`
--
...
--
-- Struktura tabulky `character_instance`
--
...
--
-- Struktura tabulky `character_inventory`
--
...
--
-- Struktura tabulky `character_pet`
--
...
--
-- Struktura tabulky `character_pet_declinedname`
--
...
--
-- Struktura tabulky `character_queststatus`
--
...
--
-- Struktura tabulky `character_queststatus_daily`
--
...
--
-- Struktura tabulky `character_queststatus_rewarded`
--
...
--
-- Struktura tabulky `character_queststatus_weekly`
--
...
--
-- Struktura tabulky `character_reputation`
--
...
--
-- Struktura tabulky `character_skills`
--
...
--
-- Struktura tabulky `character_social`
--
...
--
-- Struktura tabulky `character_spell`
--
...
--
-- Struktura tabulky `character_spell_cooldown`
--
...
--
-- Struktura tabulky `character_stats`
--
...
--
-- Struktura tabulky `character_talent`
--
...
--
-- Struktura tabulky `creature_respawn`
--
...
--
-- Struktura tabulky `gameobject_respawn`
--
...
--
-- Struktura tabulky `game_event_condition_save`
--
...
--
-- Struktura tabulky `game_event_save`
--
...
--
-- Struktura tabulky `gm_subsurveys`
--
...
--
-- Struktura tabulky `group_instance`
--
...
--
-- Struktura tabulky `group_member`
--
...
--
-- Struktura tabulky `guild_bank_eventlog`
--
...
--
-- Struktura tabulky `guild_bank_item`
--
...
--
-- Struktura tabulky `guild_bank_right`
--
...
--
-- Struktura tabulky `guild_bank_tab`
--
...
--
-- Struktura tabulky `guild_eventlog`
--
...
--
-- Struktura tabulky `guild_member`
--
...
--
-- Struktura tabulky `instance_reset`
--
...
--
-- Struktura tabulky `item_instance`
--
...
--
-- Struktura tabulky `item_refund_instance`
--
...
--
-- Struktura tabulky `item_soulbound_trade_data`
--
...
--
-- Struktura tabulky `petition_sign`
--
...
--
-- Struktura tabulky `pet_spell_cooldown`
--
...
--
-- Struktura tabulky `pool_quest_save`
--
...
--
-- Struktura tabulky `reserved_name`
--
