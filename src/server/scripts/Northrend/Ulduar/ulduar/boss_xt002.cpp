...
enum Yells
{
    ...
    SAY_DEATH                                   = -1603307,
    SAY_SUMMON                                  = -1603308,
    EMOTE_TYMPANIC                              = -1603350,
    EMOTE_HEART                                 = -1603351,
    EMOTE_REPAIR                                = -1603352,
};
...
public:
    ...
    struct boss_xt002_AI : public BossAI
    {
        ...
        void Reset()
        {
            ...
            uiSearingLightTimer = 10000;
            uiSpawnLifeSparkTimer = 9000;
            uiGravityBombTimer = 20000;
            uiSpawnGravityBombTimer = 9000;
            uiHeartPhaseTimer = 35000;
            uiSpawnAddTimer = 12000;
            uiEnrageTimer = 600000;
            uiTympanicTantrumTimer = 30000;
