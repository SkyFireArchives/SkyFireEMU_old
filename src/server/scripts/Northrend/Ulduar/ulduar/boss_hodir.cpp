...
public:
    ...
    struct boss_hodirAI : public BossAI
    {
        boss_hodirAI(Creature *pCreature) : BossAI(pCreature, BOSS_HODIR)
        {
            ...
            me->ApplySpellImmune(0, IMMUNITY_ID, SPELL_SINGED_IMMUN, true);  // Singed
        }
                        ...
                        case 2:
                            ...
                            if (instance)
                            {
                                ...
                                if (RareCache)
                                {
                                    ...
                                    /*instance->SetData(BOSS_HODIR_RARE_CHEST, GO_STATE_READY);*/
                                }
