...
public:
    ...
    struct boss_falricAI : public boss_horAI
    {
        ...
        void Reset()
        {
            ...
            if (pInstance)
                pInstance->SetData(TYPE_FALRIC, NOT_STARTED);
        }
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            events.ScheduleEvent(EVENT_DEFILING_HORROR, urand(10000,11000)); // TODO adjust timer.
        }
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_DEFILING_HORROR:
                    DoCastAOE(DUNGEON_MODE(SPELL_DEFILING_HORROR,SPELL_DEFILING_HORROR));
                    events.ScheduleEvent(EVENT_DEFILING_HORROR, urand(15000,17000)); // TODO adjust timer.
                    break;
            }
