...
public:
    ...
    struct instance_nexus_InstanceMapScript : public InstanceScript
    {
                ...
                case 26793:
                    ...
                    else
                    {
                        if (pCreature->isAlive())
                            FrayerGUIDlist.insert(pCreature->GetGUID());
                    }
                    break;
                case 26731:
                    TelestraMagus = pCreature->GetGUID();
                    break;
        ...
        uint64 GetData64(uint32 uiIdentifier)
        {
            switch(uiIdentifier)
            {
                case DATA_MAGUS_TELESTRA_EVENT:     return TelestraMagus;
