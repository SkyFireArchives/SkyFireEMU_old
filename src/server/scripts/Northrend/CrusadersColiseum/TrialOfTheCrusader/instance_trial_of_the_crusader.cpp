    ...
    public:
        ...
        struct instance_trial_of_the_crusader_InstanceMapScript : public InstanceScript
        {
            ...
            void OnCreatureCreate(Creature *pCreature, bool /*bAdd*/)
            {
                ...
                {
                    case NPC_BARRENT:
                        BarrentGUID = pCreature->GetGUID();
                        break;
                    case NPC_TIRION:
                        TirionGUID = pCreature->GetGUID();
                        break;
                    case NPC_FIZZLEBANG:
                        FizzlebangGUID = pCreature->GetGUID();
                        break;
                    case NPC_GARROSH:
                        GarroshGUID = pCreature->GetGUID();
                        break;
                    case NPC_VARIAN:
                        VarianGUID = pCreature->GetGUID();
                        break;

                    case NPC_GORMOK:
                        GormokGUID = pCreature->GetGUID();
                        break;
                    case NPC_ACIDMAW:
                        AcidmawGUID = pCreature->GetGUID();
                        break;
                    case NPC_DREADSCALE:
                        DreadscaleGUID = pCreature->GetGUID();
                        break;
                    case NPC_ICEHOWL:
                        IcehowlGUID = pCreature->GetGUID();
                        break;
                    case NPC_JARAXXUS:
                        JaraxxusGUID = pCreature->GetGUID();
                        break;
                    case NPC_CHAMPIONS_CONTROLLER:
                        ChampionsControllerGUID = pCreature->GetGUID();
                        break;
                    case NPC_DARKBANE:
                        DarkbaneGUID = pCreature->GetGUID();
                        break;
                    case NPC_LIGHTBANE:
                        LightbaneGUID = pCreature->GetGUID();
                        break;
                    case NPC_ANUBARAK:
                        AnubarakGUID = pCreature->GetGUID();
                        break;
                }
            }
                ...
                switch (pGo->GetEntry())
                {
                    case GO_CRUSADERS_CACHE_10:
                        if (instance->GetSpawnMode() == RAID_DIFFICULTY_10MAN_NORMAL)
                            CrusadersCacheGUID = pGo->GetGUID();
                        break;
                    ...
                    case GO_ARGENT_COLISEUM_FLOOR:
                        FloorGUID = pGo->GetGUID();
                        break;
                    case GO_MAIN_GATE_DOOR:
                        MainGateDoorGUID = pGo->GetGUID();
                        break;
                    case GO_EAST_PORTCULLIS:
                        EastPortcullisGUID = pGo->GetGUID();
                        break;
                    case GO_WEB_DOOR:
                        WebDoorGUID = pGo->GetGUID();
                        break;
