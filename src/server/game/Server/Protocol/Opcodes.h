...
enum Opcodes
{
    ...
    SMSG_CHAR_CREATE                                = 0xCD56, // (0xC211)(0x003A) //
    ...
    CMSG_LOGOUT_REQUEST                             = 0xFFF5, // NF(0x62D1)(0x004B) //
    ...
    CMSG_NAME_QUERY                                 = 0xFFF1, // NF(0x4354)(0x0050) //
    SMSG_NAME_QUERY_RESPONSE                        = 0x4D5E, // (0x0A14)(0x0051) //
    CMSG_PET_NAME_QUERY                             = 0xFFF0, // NF(0xABF1)(0x0052) //
    SMSG_PET_NAME_QUERY_RESPONSE                    = 0xFFEF, // NF(0x090C)(0x0053) //
    CMSG_GUILD_QUERY                                = 0xFF88, // NF(0x4B18)(0x0054) //
    SMSG_GUILD_QUERY_RESPONSE                       = 0x365C, // (0xEA1D)(0x0055) //
    CMSG_ITEM_QUERY_SINGLE                          = 0xFF01, // NF(0x5621)(0x0056) //
    CMSG_ITEM_QUERY_MULTIPLE                        = 0x0057, // NF()(0x0057) // 
    SMSG_ITEM_QUERY_SINGLE_RESPONSE                 = 0xFFED, // NF(0x8014)(0x0058) //
    SMSG_ITEM_QUERY_MULTIPLE_RESPONSE               = 0x0059, // NF()(0x0059) // 
    CMSG_PAGE_TEXT_QUERY                            = 0xFFEC, // NF(0xEABD)(0x005A) //
    SMSG_PAGE_TEXT_QUERY_RESPONSE                   = 0xFFEB, // NF(0x8848)(0x005B) //
    CMSG_QUEST_QUERY                                = 0xFFEA, // NF(0xE27C)(0x005C) //
    SMSG_QUEST_QUERY_RESPONSE                       = 0xFFE9, // NF(0x28C4)(0x005D) //
    CMSG_GAMEOBJECT_QUERY                           = 0xFFE8, // NF(0x8239)(0x005E) //
    SMSG_GAMEOBJECT_QUERY_RESPONSE                  = 0x0577, // (0x0231)(0x005F) //
    CMSG_CREATURE_QUERY                             = 0xFFE7, // NF(0xE3D5)(0x0060) //
    ...
    SMSG_TUTORIAL_FLAGS                             = 0xFFD9, // NF(0x4B31)(0x00FD) //
    ...
    CMSG_TEXT_EMOTE                                 = 0x6A08, // (0xD200)(0x0104) // 
    ...
    CMSG_CANCEL_TRADE                               = 0xFFD6, // NF(0x1F72)(0x011C) //
    ...
    CMSG_SET_ACTION_BUTTON                          = 0x0128, // NF()(0x0128) // 
    ...
    SMSG_ITEM_PUSH_RESULT                           = 0xDF54, // (0x835D)(0x0166) //
    SMSG_DUEL_REQUESTED                             = 0x575E, // (0xCAF1)(0x0167) //
    SMSG_DUEL_OUTOFBOUNDS                           = 0xBC7D, // (0x2350)(0x0168) //
    SMSG_DUEL_INBOUNDS                              = 0x9F54, // (0x2ADD)(0x0169) //
    SMSG_DUEL_COMPLETE                              = 0xE777, // (0x6B74)(0x016A) //
    SMSG_DUEL_WINNER                                = 0x277D, // (0xEB95)(0x016B) //
    ...
    SMSG_PET_SPELLS                                 = 0xFE5C, // (0x03F0)(0x0179) //
    SMSG_PET_MODE                                   = 0xE754, // (0x4A1C)(0x017A) //
    ...
    SMSG_GOSSIP_COMPLETE                            = 0x475F, // (0x6BF9)(0x017E) //
    CMSG_NPC_TEXT_QUERY                             = 0xFFD5, // NF(0x2BBD)(0x017F) //
    ...
    CMSG_PING                                       = 0x01DC, // NF()(0x01DC) // 
    SMSG_PONG                                       = 0xFFCF, // NF(0xC500)(0x01DD) //
    ...
    SMSG_PARTYKILLLOG                               = 0x7657, // (0xCA39)(0x01F5) //
    ...
    SMSG_RWHOIS                                     = 0x367C, // (0xC35D)(0x01FE) //
    ...
    SMSG_GOSSIP_POI                                 = 0x1456, // (0x0BD9)(0x0224) //
    ...
    SMSG_MAIL_LIST_RESULT                           = 0x3C54, // (0xABD1)(0x023B) //
    ...
    SMSG_ITEM_TEXT_QUERY_RESPONSE                   = 0xFFC1, // NF(0x8000)(0x0244) //
    ...
    SMSG_ZONE_UNDER_ATTACK                          = 0xEC55, // (0x6215)(0x0254) //
    ...
    SMSG_AUCTION_COMMAND_RESULT                     = 0xEF76, // (0xAB5D)(0x025B) //
    SMSG_AUCTION_LIST_RESULT                        = 0xEE5E, // (0x827C)(0x025C) //
    SMSG_AUCTION_OWNER_LIST_RESULT                  = 0xDE76, // (0x4B94)(0x025D) //
    SMSG_AUCTION_BIDDER_NOTIFICATION                = 0x3475, // (0x4250)(0x025E) //
    SMSG_AUCTION_OWNER_NOTIFICATION                 = 0xC45D, // (0x42B5)(0x025F) //
    ...
    SMSG_AUCTION_BIDDER_LIST_RESULT                 = 0xAF57, // (0x42D5)(0x0265) //
    ...
    SMSG_STABLE_RESULT                              = 0x0273, // NF()(0x0273) // 
    ...
    SMSG_RECEIVED_MAIL                              = 0x2576, // (0x4A54)(0x0285) //
    ...
    SMSG_AUCTION_REMOVED_NOTIFICATION               = 0x0E5E, // (0x4379)(0x028D) //
    ...
    SMSG_SERVER_MESSAGE                             = 0x2554, // (0x221C)(0x0291) //
    ...
    SMSG_PET_BROKEN                                 = 0xED7F, // (0x6A71)(0x02AF) //
    ...
    SMSG_DUEL_COUNTDOWN                             = 0x8E75, // (0x8A54)(0x02B7) //
    ...
    SMSG_PET_ACTION_FEEDBACK                        = 0xAC54, // (0x0370)(0x02C6) //
    ...
    SMSG_WARDEN_DATA                                = 0x257F, // (0x23DD)(0x02E6) //
    ...
    SMSG_MINIGAME_SETUP                             = 0x1C74, // (0x82FC)(0x02F6) //
    SMSG_MINIGAME_STATE                             = 0x4C7F, // (0x6B9C)(0x02F7) //
    CMSG_MINIGAME_MOVE                              = 0x02F8, // NF()(0x02F8) // 
    SMSG_MINIGAME_MOVE_FAILED                       = 0x02F9, // NF()(0x02F9) // 
    SMSG_RAID_INSTANCE_MESSAGE                      = 0xDD7D, // (0xEB78)(0x02FA) //
    SMSG_COMPRESSED_MOVES                           = 0x9E55, // (0x0A54)(0x02FB) //
    ...
    SMSG_INVALIDATE_PLAYER                          = 0xFFB8, // NF(0xA8C5)(0x031C) //
    CMSG_RESET_INSTANCES                            = 0x031D, // NF()(0x031D) // 
    SMSG_INSTANCE_RESET                             = 0x1F7C, // (0x2B34)(0x031E) //
    SMSG_INSTANCE_RESET_FAILED                      = 0xD65C, // (0xCAB8)(0x031F) //
    SMSG_UPDATE_LAST_INSTANCE                       = 0x9F75, // (0x2B91)(0x0320) //
    ...
    SMSG_UPDATE_INSTANCE_OWNERSHIP                  = 0x8775, // (0xCB5D)(0x032B) //
    ...
    SMSG_EXPECTED_SPAM_RECORDS                      = 0xA55C, // (0xABDD)(0x0332) //
    ...
    SMSG_DEFENSE_MESSAGE                            = 0x6474, // (0xA27C)(0x033A) //
    ...
    SMSG_ARENA_TEAM_QUERY_RESPONSE                  = 0xFFB6, // NF(0x21A0)(0x034C) //
    CMSG_ARENA_TEAM_ROSTER                          = 0x034D, // NF()(0x034D) 
    SMSG_ARENA_TEAM_ROSTER                          = 0xAC5E, // (0x23F1)(0x034E) //
    ...
    SMSG_ARENA_TEAM_STATS                           = 0x9F5F, // (0x03B4)(0x035B) //
    ...
    SMSG_TITLE_EARNED                               = 0x465F, // (0x0B91)(0x0373) //
    ...
    SMSG_OFFER_PETITION_ERROR                       = 0xBF7E, // (0x8B11)(0x038F) //
    SMSG_TIME_SYNC_REQ                              = 0X6F5E, // (0xA318)(0x0390) //
    CMSG_TIME_SYNC_RESP                             = 0x0391, // NF()(0x0391) // 
    ...
    SMSG_GM_MESSAGECHAT                             = 0x2D56, // (0xE3B0)(0x03B3) //
    ...
    SMSG_KICK_REASON                                = 0x3774, // (0x4A71)(0x03C5) //
    ...
    SMSG_FEATURE_SYSTEM_STATUS                      = 0x5C74, // NF(0xA37C)(0x03C9) //
    ...
    SMSG_CHANNEL_MEMBER_COUNT                       = 0x0C77, // (0xAAB1)(0x03D5) //
    ...
    SMSG_COMSAT_RECONNECT_TRY                       = 0x7E7E, // (0x63F8)(0x03E0) //
    SMSG_COMSAT_DISCONNECT                          = 0x2E57, // (0xCB71)(0x03E1) //
    SMSG_COMSAT_CONNECT_FAIL                        = 0xF656, // (0x4B59)(0x03E2) //
    SMSG_VOICE_CHAT_STATUS                          = 0x8D77, // (0x627D)(0x03E3) //
    ...
    SMSG_GUILD_BANK_LIST                            = 0xBC76, // (0xE3D0)(0x03E8) //
    ...
    MSG_GUILD_BANK_LOG_QUERY                        = 0x675C, // (0xEB34)(0x03EE) //
    CMSG_SET_CHANNEL_WATCH                          = 0x2D54, // (0xC37C)(0x03EF) //
    SMSG_USERLIST_ADD                               = 0xBE74, // (0xC2FC)(0x03F0) //
    SMSG_USERLIST_REMOVE                            = 0x267C, // (0xCBB9)(0x03F1) //
    SMSG_USERLIST_UPDATE                            = 0xE75F, // (0xAA5C)(0x03F2) //
    CMSG_CLEAR_CHANNEL_WATCH                        = 0x03F3, // NF()(0x03F3) // 
    SMSG_INSPECT_TALENT                             = 0x857E, // (0x6B3D)(0x03F4) //
    SMSG_GOGOGO_OBSOLETE                            = 0x03F5, // NF()(0x03F5) // 
    SMSG_ECHO_PARTY_SQUELCH                         = 0x1757, // (0xA3DD)(0x03F6) //
    ...
    MSG_GUILD_BANK_MONEY_WITHDRAWN                  = 0x347E, // (0x8B34)(0x03FE) //
    ...
    SMSG_RAID_READY_CHECK_ERROR                     = 0x547E, // (0xCB50)(0x0408) //
    CMSG_OPT_OUT_OF_LOOT                            = 0x0409, // NF()(0x0409) // 
    MSG_QUERY_GUILD_BANK_TEXT                       = 0x2776, // (0x03DD)(0x040A) //
    ...
    SMSG_NOTIFY_DANCE                               = 0xE75C, // (0x223D)(0x044A) //
    CMSG_PLAY_DANCE                                 = 0xBC57, // (0x0318)(0x044B) //
    SMSG_PLAY_DANCE                                 = 0xC657, // (0x8BBD)(0x044C) //
    CMSG_LOAD_DANCES                                = 0x044D, // NF()(0x044D) // 
    CMSG_STOP_DANCE                                 = 0x044E, // NF()(0x044E) // 
    SMSG_STOP_DANCE                                 = 0x4456, // (0xCA50)(0x044F) //
    CMSG_SYNC_DANCE                                 = 0x0450, // NF()(0x0450) // 
    CMSG_DANCE_QUERY                                = 0xFFA0, // NF(0xAB1D)(0x0451) //
    SMSG_DANCE_QUERY_RESPONSE                       = 0x7C54, // (0xCB10)(0x0452) //
    SMSG_INVALIDATE_DANCE                           = 0xFF9F, // NF(0xC900)(0x0453) //
    CMSG_DELETE_DANCE                               = 0x0454, // NF()(0x0454) // 
    SMSG_LEARNED_DANCE_MOVES                        = 0xF65D, // (0x22D5)(0x0455) //
    ...
    SMSG_PET_RENAMEABLE                             = 0x565E, // (0x22F8)(0x0475) //
    ...
    SMSG_HIGHEST_THREAT_UPDATE                      = 0x7677, // (0xABF8)(0x0482) //
    SMSG_THREAT_UPDATE                              = 0x3C7D, // (0xEB5C)(0x0483) //
    ...
    SMSG_PET_GUIDS                                  = 0xFE5C, // (0x03F0)(0x04AA) //
    ...
    SMSG_ARENA_OPPONENT_UPDATE                      = 0x04C7, // NF()(0x04C7) // // uint64, EVENT_ARENA_OPPONENT_UPDATE
    ...
    SMSG_REDIRECT_CLIENT                            = 0xFF91, // NF(0x8400)(0x050D) //, uint16 port, uint32 unk, uint8[20] hash (ip + port, seed=sessionkey)
    ...
    SMSG_COMBAT_LOG_MULTIPLE                        = 0xFF90, // NF(0x4AB4)(0x0514) //
