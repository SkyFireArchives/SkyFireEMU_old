...
enum Opcodes
{
    ...
    SMSG_GUILD_DECLINE                               = 0x07DEC, // 
    CMSG_GUILD_INFO                                  = 0x06884, // 4.0.6a 13623
    SMSG_GUILD_INFO                                  = 0x020A8, // 
    ...
    CMSG_GUILD_DISBAND                               = 0x01B42, //
    CMSG_GUILD_LEADER                                = 0x00D02, //
    CMSG_GUILD_MOTD                                  = 0x0272D, // 4.0.6a 13623
    SMSG_GUILD_EVENT                                 = 0x0B7C4, // 
    SMSG_GUILD_COMMAND_RESULT                        = 0x0BE5D, //
    ...
    MSG_MOVE_SET_RUN_MODE                            = 0x060E4, // 
    MSG_MOVE_SET_WALK_MODE                           = 0x0ADC4, // 
    ...
    MSG_MOVE_START_SWIM                              = 0x0AE57, //
    MSG_MOVE_STOP_SWIM                               = 0x0AC7D, //
    ...
    MSG_MOVE_SET_TURN_RATE                           = 0x0AC75, //
    MSG_MOVE_TOGGLE_COLLISION_CHEAT                  = 0x0ABC4, // 
    MSG_MOVE_SET_FACING                              = 0x0865D, //
    ...
    CMSG_NEXT_CINEMATIC_CAMERA                       = 0x0B2CC, // 
    CMSG_COMPLETE_CINEMATIC                          = 0x0CC55, //
    SMSG_TUTORIAL_FLAGS                              = 0x03384, // 4.0.6a 13623
    CMSG_TUTORIAL_FLAG                               = 0x0E4CC, // 
    CMSG_TUTORIAL_CLEAR                              = 0x0A5E4, // 
    CMSG_TUTORIAL_RESET                              = 0x0DE75, //
    ...
    CMSG_AUTOSTORE_LOOT_ITEM                         = 0x0F457, //
    ...
    CMSG_SWAP_INV_ITEM                               = 0x0CD75, //
    CMSG_SPLIT_ITEM                                  = 0x0FDAC, // 4.0.6a 13623
    CMSG_AUTOEQUIP_ITEM_SLOT                         = 0x0C775, //
    ...
    SMSG_INITIALIZE_FACTIONS                         = 0x025C0, // 
    SMSG_SET_FACTION_VISIBLE                         = 0x03988, // 
    SMSG_SET_FACTION_STANDING                        = 0x0718C, // 
    CMSG_SET_FACTION_ATWAR                           = 0x10055, //
    CMSG_SET_FACTION_CHEAT                           = 0x10056, //
    SMSG_SET_PROFICIENCY                             = 0x0BBA8, // 
    CMSG_SET_ACTION_BUTTON                           = 0x072E8, // 
    SMSG_ACTION_BUTTONS                              = 0x02CCC, // 
    SMSG_INITIAL_SPELLS                              = 0x06584, // 
    SMSG_LEARNED_SPELL                               = 0x076E8, // 
    SMSG_SUPERCEDED_SPELL                            = 0x0E8E4, // 
    CMSG_NEW_SPELL_SLOT                              = 0x10057, //
    CMSG_CAST_SPELL                                  = 0x065C4, // 4.0.6a 13623
    CMSG_CANCEL_CAST                                 = 0x0A1C0, // 4.0.6a 13623
    SMSG_CAST_FAILED                                 = 0x0D45D, //
    SMSG_SPELL_START                                 = 0x06BA8, // 
    SMSG_SPELL_GO                                    = 0x030C0, // 
    SMSG_SPELL_FAILURE                               = 0x05657, //
    SMSG_SPELL_COOLDOWN                              = 0x0E555, //
    SMSG_COOLDOWN_EVENT                              = 0x06576, //
    CMSG_CANCEL_AURA                                 = 0x07684, // 4.0.6a 13623
    SMSG_EQUIPMENT_SET_SAVED                         = 0x0B0C0, // 
    SMSG_PET_CAST_FAILED                             = 0x0CD74, //
    MSG_CHANNEL_START                                = 0x08574, //
    MSG_CHANNEL_UPDATE                               = 0x0C654, //
    CMSG_CANCEL_CHANNELLING                          = 0x0A780, // 4.0.6a 13623
    SMSG_AI_REACTION                                 = 0x031CC, // 4.0.6a 13623
    CMSG_SET_SELECTION                               = 0x05577, //
    ...
    SMSG_ATTACKSWING_BADFACING                       = 0x067A8, // 
    SMSG_INSTANCE_LOCK_WARNING_QUERY                 = 0x0B574, //
    SMSG_ATTACKSWING_DEADTARGET                      = 0x0A7C4, // 
    SMSG_ATTACKSWING_CANT_ATTACK                     = 0x06188, // 
    SMSG_ATTACKERSTATEUPDATE                         = 0x0BBC0, // 
    SMSG_BATTLEFIELD_PORT_DENIED                     = 0x10059, //
    SMSG_DAMAGE_DONE_OBSOLETE                        = 0x1005A, //
    SMSG_UNIT_SPELLCAST_START                        = 0x0BE55, //
    SMSG_CANCEL_COMBAT                               = 0x0BAE4, // 
    SMSG_SPELLBREAKLOG                               = 0x0ED7E, //
    SMSG_SPELLHEALLOG                                = 0x09D7D, //
    SMSG_SPELLENERGIZELOG                            = 0x08C5D, //
    SMSG_BREAK_TARGET                                = 0x1005B, //
    CMSG_SAVE_PLAYER                                 = 0x1005C, //
    CMSG_SETDEATHBINDPOINT                           = 0x1005D, //
    SMSG_BINDPOINTUPDATE                             = 0x0A9A0, // 
