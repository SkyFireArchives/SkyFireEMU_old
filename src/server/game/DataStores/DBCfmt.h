...
const char SpellEntryfmt[]=           "niiiiiiiiixxiiiifiiiisixxiixxixiiiiiiixiiiiixiix";
...
const char SpellEffectfmt[]="nifiiiffiiiiiifixfiiiiiiiix";
...
const char SpellTargetRestrictionsfmt[]="nixiii";
