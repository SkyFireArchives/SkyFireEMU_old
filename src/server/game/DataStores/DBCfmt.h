...
const char AchievementCriteriafmt[]="niiiiiiiiiiiisiiiiixx"; //"niiiiiiiixixiiixxxxxxxx"
...
const char BattlemasterListEntryfmt[]="niiiiiiiiixsiiii"; //"niiiiiiiiixsiiiix" in 12942!
...
const char ChrClassesEntryfmt[]="nixsxxxixiixxx"; //"nixxxxxixiixxx"
...
const char MapEntryfmt[]="nxixxxsixxixiffxiix"; //"nxixxxsixxixiffxiixx" IN 12942 !
